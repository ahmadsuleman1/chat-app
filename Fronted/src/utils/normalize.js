...
export function normalizeMessage(raw) {
  ...
  return {
    ...
    text: raw.text || '',
    type: raw.type || 'text',
    attachment: raw.attachment || raw.VoiceUrl || null,
    voiceUrl: raw.VoiceUrl || raw.voiceUrl || raw.attachment || null,
    voiceDuration: Number(raw.Voiceduration ?? raw.voiceDuration ?? raw.duration ?? raw.audioDuration ?? 0),
